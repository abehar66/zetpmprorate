		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Prorateo de Gastos para Piezas",
									"targetURL": "#zetpmprorate-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zetpmprorate-display": {
								"semanticObject": "zetpmprorate",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zetpmprorate",
									"url": sap.ui.require.toUrl("zetpmprorate")
								}
							}
						}
					}
